...
const heroImage = "/assets/campfire-night.jpg";
const feynman1 = "/assets/richard_feynman_1.jpeg";
const feynman2 = "/assets/richard_feynman_2.jpeg";
      ...
      <section className="bg-warm-white section-padding py-20 lg:py-28">
        <div className="max-w-3xl mx-auto text-center">
          <ScrollReveal>
            ...
            <Link href="/contact" className="feynman-link mt-8 inline-flex items-center gap-2 font-body text-sm font-medium">
